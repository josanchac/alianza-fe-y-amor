...
Cada nueva entrega cambia número y fecha, añade CHANGELOG y evidencia, y conserva commits/publicaciones previas. La nueva línea de espacios independientes usa 0.2.0-alpha.1; las correcciones de esta línea continuarán como 0.2.0-alpha.6. Nunca reemplazar el contenido de una versión ya entregada.

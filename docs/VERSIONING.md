...
- **Alfa privada**: funcionalidades en evaluación con el piloto existente; cambios de experiencia esperables. Versión actual 0.1.0-alpha.1.
...
Cada nueva entrega cambia número y fecha, añade CHANGELOG y evidencia, y conserva commits/publicaciones previas. Alfa siguiente: 0.1.0-alpha.2; una nueva línea funcional puede pasar a 0.2.0-alpha.1. Nunca reemplazar el contenido de una versión ya entregada.

...
## Refinamiento de carga cognitiva · 13/9/2026

A partir de las capturas del propietario, se conservan colores y emblema y se sustituyen superficies de lectura frecuentes por acciones concretas. El propósito muestra un anillo de avance y pasos discretos, un botón «Lo viví hoy», fecha opcional en fila propia y confirmación después de guardar. Los registros y la meta mantienen las mismas reglas de conteo y corrección. El rosario ofrece cinco decenas seleccionables y una sola tarjeta de acción a la vez; las confirmaciones continúan siendo explícitas. Mi espacio usa accesos con iconos, paneles enfocados y acceso directo a instalación e información del Movimiento.

Fundamento: [divulgación progresiva, Nielsen Norman Group](https://www.nngroup.com/articles/progressive-disclosure/), para presentar acciones frecuentes primero y explicación secundaria bajo demanda; [teoría de la autodeterminación](https://selfdeterminationtheory.org/theory/), como criterio para apoyar autonomía, sensación de progreso y vínculo. La traducción a anillo, pasos y confirmaciones es una decisión de diseño de Alianza, no una técnica espiritualmente prescrita ni una intervención cuya eficacia se haya demostrado en este piloto. No se añaden clasificaciones, premios por prácticas religiosas, pérdidas de rachas ni puntuaciones de fe.

Comprobación en navegador supervisado con datos ficticios: propósito 1→2; selector de fecha y acción en filas distintas a 320 px, sin desbordamiento horizontal; panel de recordatorio contenido en el ancho móvil y foco devuelto al acceso; selección de decena y confirmación de rezo. La hoja móvil corrige también el desplazamiento de las utilidades CSS de diálogo. El marco de revisión solo aparece en escritorio; en teléfono la demo abre la app directamente.

Se conservan consentimiento, límites de acceso, borradores y separación entre examen y confesión. No se modifica SQL ni contenido doctrinal. Las comprobaciones de interfaz no equivalen a una prueba física en Safari/iPhone ni demuestran por sí solas una reducción de carga cognitiva: esta última se evaluará con tareas observadas y el plan de medición ya documentado.

...
export const reflectionFields=[['gratitude','Mis agradecimientos'],['offering','Mis ofrecimientos a la Mater'],['note','Mis notas por compromiso'],['learning','Lo que aprendí'],['next','Mis próximos pasos']] as const;

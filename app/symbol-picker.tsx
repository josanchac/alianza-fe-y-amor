...
import {SupportForm} from './pilot-support';
...
export function SymbolPicker({value,onChange,onBusy}:{value:Appearance;onChange:(v:Appearance)=>void;onBusy:(b:boolean)=>void}){
 const [error,setError]=useState(''),[processing,setProcessing]=useState(false);const generation=useRef(0);
 ...
 <details><summary>Solicitar un símbolo</summary><SupportForm/></details></details>

...
const fixture=()=>({user:{id:'fixture',role:'member',email:'fixture@example.test',relationshipVersion:1,dataEpoch:epoch,coupleId:null},own:[{kind:'spaces',key:'experience',data:{enabled:['personal'],start:'personal'},version:1},{kind:'profile',key:'me',data:{name:'Persona',ideal:'',shareSchedule:false,shareNotes:false},version:1}],shared:[],partner:null,today:'2026-09-12'});
...
try{
 ...
 assert(!screen.queryByRole('heading',{name:'Mis compromisos'}));
